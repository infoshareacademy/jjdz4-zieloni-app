...
<%@page import="com.infoshareacademy.zieloni.admin.charts.ChartActivityDependingOnGender" %>
...
<%
    ...
    for (Map.Entry m : ChartActivityDependingOnGender.actualGenderData.entrySet()) {
