...
<%@ page import="com.infoshareacademy.zieloni.ChartActivityDependingOnAge" %>
<%@ page import="com.infoshareacademy.zieloni.ChartActivityDependingOnGender" %>

<div class="blackshape" style="width: 800px; height: 600px;">
    <h3>Aktywność użytkowników ze względu na płeć</h3>
    <div id="chart"></div>
...
<%Gson gson = new Gson();
    ...
    chartobj.put("paletteColors", "#FF0000,#0099FF,#f2c500,#f45b00,#8e0000");
    ...
    for (Map.Entry m : ChartActivityDependingOnGender.actualData1.entrySet()) {
