...
public class CSVReaderTest {
    ...
    public void csvReader_variant1() throws Exception {
        ...
        List<String> variant1RecordArray = CSVReader.readCSVfileAndConvertToRecordsArray(filePath.get(0).getVariant1());
    ...
    public void csvReader_variant2() throws Exception {
        List<FilePathDTO> filePath = PathFinder.addAllFilesPathToArrayList("rozklady_2015-09-08_13.43.01");
        List<String> variant2RecordArray = CSVReader.readCSVfileAndConvertToRecordsArray(filePath.get(0).getVariant2());
    ...
    public void csvReader_getCourse1() throws Exception {
        List<FilePathDTO> filePath = PathFinder.addAllFilesPathToArrayList("rozklady_2015-09-08_13.43.01");
        List<String> course1RecordArray = CSVReader.readCSVfileAndConvertToRecordsArray(filePath.get(0).getCourse1());
