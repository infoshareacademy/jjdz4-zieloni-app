...
public class FindBusInterchangesController {
    ...
    private static void checkBusForVaraint(int id, BusDTO busDTO, ArrayList<RecordVariantCsvDTO> busStops, ArrayList<RecordCourseDTO> courseRecords, Map<String, ArrayList<String>> columnMap, int variant) {
        ...
        if (find_startBusStop_index >0) {
            System.out.println(variant +"startowy  nr "+busDTO.getBusNumber());
        }
        ...
        if ( find_endBusStop_index  >0) {
            System.out.println(variant +"koncowy  nr "+busDTO.getBusNumber());
        }*/
       ...
       // if (find_startBusStop_index < find_endBusStop_index && find_startBusStop_index > -1) {
         //  System.out.println("------------------------------------------------------\n");
           // System.out.println("Proponowany  nr "+busDTO.getBusNumber());
